...
module.exports = function(app) {
  ...
  app.post('/post', function(req, res) {
    var currentUser = req.session.user,
        ...
        post = new Posts(currentUser.name, currentUser.head, req.body.title, tags, req.body.post);
  ...
  app.get('/search', function (req, res) {
    Posts.search(req.query.keyword, function (err, posts) {
      if (err) {
        req.flash('error', err); 
        return res.redirect('/');
      }
...
app.get('/reprint/:name/:day/:title', function (req, res) {
  Posts.edit(req.params.name, req.params.day, req.params.title, function (err, post) {
    if (err) {
      req.flash('error', err); 
      return res.redirect(back);
    }
    ...
    Posts.reprint(reprint_from, reprint_to, function (err, post) {
      if (err) {
        req.flash('error', err); 
        return res.redirect('back');
      }
